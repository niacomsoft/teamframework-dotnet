...
namespace Niacomsoft.TeamFramework.Extensions.Logging
{
    public partial interface ILogWriter
    {
        ...
        /// <seealso cref="LogLevel.Trace" />
        /// <seealso cref="Type" />
        void LogTrace(string message, Type category = null);
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogTrace<TCategory>(string message);

        /// <summary> 记录运行时追踪级别异常日志。 </summary>
        /// <param name="error">
        /// 运行时异常。
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogTrace(Exception error, string cause = null);
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogTrace<TCategory>(Exception error, string cause = null);
    }
}