...
namespace Niacomsoft.TeamFramework.Extensions.Logging
{
    public partial interface ILogWriter
    {
        ...
        /// <seealso cref="LogLevel.Trace" />
        /// <seealso cref="Type" />
        void LogFatal(string message, Type category = null);
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogFatal<TCategory>(string message);

        /// <summary> 记录运行时崩溃致命级别异常日志。 </summary>
        /// <param name="error">
        /// 运行时异常。
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogFatal(Exception error, string cause = null);
        ...
        /// <seealso cref="LogLevel" />
        /// <seealso cref="LogLevel.Trace" />
        void LogFatal<TCategory>(Exception error, string cause = null);
    }
}