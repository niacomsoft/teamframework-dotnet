...
namespace Niacomsoft.Utilities
{
    public static partial class AssertUtilities
    {
        ...
        public static bool Equals(short a, short b = 0)
            => a == b;
        ...
        public static bool GreatThan(short a, short b = 0)
            => a > b;
        ...
        public static bool GreatThanOrEquals(short a, short b = 0)
            => a >= b;
        ...
        public static bool LessThan(short a, short b = 0)
            => a < b;
        ...
        public static bool LessThanOrEquals(short a, short b = 0)
            => a <= b;
        ...
        /// <see langword="true" />；否则返回 <see langword="false" />。
        /// </returns>
        public static bool Between(short value, short minValue = 0, short maxValue = short.MaxValue, bool excludesMinValue = true, bool excludesMaxValue = true)
        {
